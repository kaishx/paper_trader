...
tele_interval = 25 # 20 interval = 2.4 / min * 12 traders = 28.8 < 30 Telegram API limit, with some breathing space for the event updates which are interval-independent.
assigned_cptl = 25000 # assigned capital per trade. 1/4 of total starting capital of 100k. Since all will almost never come on simultaneously, this should be okayyy (?) exposure.
